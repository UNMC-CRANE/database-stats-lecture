...
-   https://github.com/UNMC-CRANE/database-stats-lecture ![Download Instructions](images/download_instructions.png)
...
-   We are now going to play around with a more complicated example using Synthea-generated synthetic data
...
-   Please open sqlite_exercises_synthea.R to complete some in-class/at-home (depending on time) exercises.
